...
describe Transcription do
  ...
  it "has a transcription" do
      transcript = Transcription.new(:transcription => "United States Constitution")
      expect(transcript.transcription).to eq("United States Constitution")
  end
